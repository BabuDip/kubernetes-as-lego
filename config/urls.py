...
urlpatterns: list[URLPattern | URLResolver] = [
    ...
    # Static/media files in DEBUG are served ASGI-natively (see config/asgi.py),
    # not through URL patterns — production serves them elsewhere entirely.
]
...
# The React SPA owns every other route (client-side routing). Must stay last.
urlpatterns += [
    re_path(
